...
const Dashboard = () => {
    ...
    return (
        <div className="flex flex-col gap-y-4">
                    ...
                    <div className="card-body h-[300px] overflow-auto p-0">
                        {recentSalesData.map((sale) => (
                            ...
                            >
                                ...
                                <p className="font-medium text-slate-900 dark:text-slate-50">R{sale.total}</p>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-4 gap-8 m-6'>
                <CategoryCard title="Crop Farming" description="Learn about the best crops for your region." image="https://images.nationalgeographic.org/image/upload/v1638892233/EducationHub/photos/crops-growing-in-thailand.jpg" label="Agriculture" />
                <CategoryCard title="Crop Farming" description="Learn about the best crops for your region." image="https://images.nationalgeographic.org/image/upload/v1638892233/EducationHub/photos/crops-growing-in-thailand.jpg" label="Agriculture" />
                <CategoryCard title="Crop Farming" description="Learn about the best crops for your region." image="https://images.nationalgeographic.org/image/upload/v1638892233/EducationHub/photos/crops-growing-in-thailand.jpg" label="Agriculture" />
                <CategoryCard title="Crop Farming" description="Learn about the best crops for your region." image="https://images.nationalgeographic.org/image/upload/v1638892233/EducationHub/photos/crops-growing-in-thailand.jpg" label="Agriculture" />
            </div>
